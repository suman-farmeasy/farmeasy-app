...
import 'package:farm_easy/Screens/MyLands/View/home_screen_land.dart';
          ...
          child: isIOS
              ? AppBar(
                  ...
                  flexibleSpace: Padding(
                    padding:
                        const EdgeInsets.only(top: 70, left: 10, bottom: 0),
                    child: Row(
        ...
        body: LayoutBuilder(builder: (context, constraints) {
          return RefreshIndicator(
              onRefresh: () async {
                ...
                recommendedlandController.recommendedLandData();
              },
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Container(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              style: GoogleFonts.poppins(fontSize: 10, fontWeight: FontWeight.w500, color: Color(0xFF61646B)),
                                                                            ),
                                                                          ),
                                                                        ],
                                                                      ),
                                                                          ...
                                                                          Row(
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              Container(
                                                                                height: 20,
                                                                                width: 20,
                                                                                decoration: BoxDecoration(image: DecorationImage(image: NetworkImage("http://openweathermap.org/img/wn/${homecontroller.landData.value.result?.data?[index].weatherDetails?.imgIcon}.png"), fit: BoxFit.fill)),
                                                                              ),
                                                                              Container(
                                                                                    ...
                                                                                    itemBuilder: (context, index) {
                                                                                      return Container(
                                                                                        ...
                                                                                        child: Row(
                                                                                          crossAxisAlignment: CrossAxisAlignment.start,
                                                                                          children: [
                                                                                            Container(width: Get.width * 0.24, decoration: BoxDecoration(image: DecorationImage(image: NetworkImage("${matchingfarmerController.matchingFarmerData.value.result?.matchingFarmerList?[index].image ?? ""}"), fit: BoxFit.cover), color: Colors.black, borderRadius: BorderRadius.only(bottomLeft: Radius.circular(18), topLeft: Radius.circular(18)))),
                                                                                            Padding(
                              ...
                              if (snapshot.hasData &&
                                ...
                                return Column(
                                  children: [
                                    ...
                                    Obx(() {
                                      return agriController.agriData.value
                                                  .result?.data?.length !=
                                              0
                                          ? Container(
                                              margin: EdgeInsets.symmetric(
                                                        ...
                                                        children: [
                                                          Container(
                                                              ...
                                                              decoration: BoxDecoration(
                                                                  image: DecorationImage(
                                                                      image: NetworkImage(
                                                                          "${agriController.agriData.value.result?.data?[index].image ?? ""}"),
                                                                      fit: BoxFit
                                                                          .cover),
                                                                  color: Colors
                                                                      .black,
                                                                  ...
                                                                  child: ListView
                                                                      .builder(
                                                                          scrollDirection: Axis
                                                                              .horizontal,
                                                                          itemCount: agriController.agriData.value.result?.data?[index].roles?.length ??
                                                                              0,
                                                                          itemBuilder:
                                                                              (context, indexes) {
                                                                            return Container(
                                                                      ...
                                                                      Get.to(() =>
                                                                          ChatScreen(
                                                                            landId:
                                                                                0,
                                                                            enquiryId:
                                                                                agriController.agriData.value.result?.data?[index].enquiryId?.toInt() ?? 0,
                                                                            userId:
                                                                                agriController.agriData.value.result?.data?[index].userId?.toInt() ?? 0,
                                                                            userType:
                              ...
                              if (snapshot.hasData &&
                                ...
                                return Column(
                                  children: [
                                    ...
                                    Obx(() {
                                      return farmerController.farmer.value
                                                  .result?.data?.length !=
                                              0
                                          ? Container(
                                              margin: EdgeInsets.symmetric(
                                                        ...
                                                        children: [
                                                          Container(
                                                              ...
                                                              decoration: BoxDecoration(
                                                                  image: DecorationImage(
                                                                      image: NetworkImage(
                                                                          "${farmerController.farmer.value.result?.data?[index].image ?? ""}"),
                                                                      fit: BoxFit
                                                                          .cover),
                                                                  color: Colors
                                                                      .black,
                                                                ...
                                                                Container(
                                                                  ...
                                                                  child: ListView
                                                                      .builder(
                                                                          scrollDirection: Axis
                                                                              .horizontal,
                                                                          itemCount: farmerController.farmer.value.result?.data?[index].expertise!.length ??
                                                                              0,
                                                                          itemBuilder:
                                                                              (context, indexes) {
                                                                            return Container(
                                                                      ...
                                                                      Get.to(() =>
                                                                          ChatScreen(
                                                                            landId:
                                                                                0,
                                                                            enquiryId:
                                                                                farmerController.farmer.value.result?.data?[index].enquiryId?.toInt() ?? 0,
                                                                            userId:
                                                                                farmerController.farmer.value.result?.data?[index].userId?.toInt() ?? 0,
                                                                            userType:
                          ...
                          child: Column(
                            ...
                            children: [
                                                                            ...
                                                                            InkWell(
                                                                              ...
                                                                              child: DottedBorder(
                                                                                ...
                                                                                child: Container(
                                                                                  ...
                                                                                  decoration: BoxDecoration(image: DecorationImage(image: NetworkImage(cropgridCalculator.selectedCropsImages[index] ?? ""))),
                                                                                  child: Center(
                                                                                    child: Row(
                                                                                      children: [],
                                                                                    ),
                                ...
                                children: [
                                  ...
                                  Obx(() {
                                    return Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color:
                                            Color(0xFF044D3A).withOpacity(0.1),
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      cropController.selectedValue.value == null
                                          ? ""
                                          : cropController.selectedValue.value
                                              .toString(),
                                      style: GoogleFonts.poppins(
                                        fontWeight: FontWeight.w500,
                                        fontSize: 12,
                              ...
                              Obx(() {
                                ...
                                double minValue =
                                    cropController.selectedValue.value == "SQFT"
                                        ? 100.0
                                        : 0.0;
                                double maxValue =
                                    cropController.selectedValue.value == "SQFT"
                                ...
                                return Column(
                                  ...
                                  children: [
                                    Slider(
                                      ...
                                      label: cropController.sliderValue.value
                                          .toStringAsFixed(2),
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Obx(
                                        () => Text(
                                          cropController.selectedCropsName
                                                      .value ==
                                                  ""
                                              ? "Search"
                                              : cropController
                                                  .selectedCropsName.value,
                                          style: TextStyle(
                                            color: Color(0xCC61646B),
                                            fontSize: 12,
                                            fontFamily: 'Poppins',
                              ...
                              Obx(
                                () => Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      cropController.selectedValuefertilizer
                                                  .value ==
                                              null
                                          ? ""
                                          : cropController
                                  ...
                                  child: Obx(
                                    () => TextFormField(
                                      onChanged: (value) {
                                        ...
                                        cropFertilizer.cropData.value.result
                              ...
                              GestureDetector(
                                onTap: () {
                                  cropFertilizerCalculator.fertilizer(
                                      cropController.sliderValuefertilizer.value
                                          .toString(),
                                      cropController
                                          .selectedValuefertilizer.value
                                          .toString(),
