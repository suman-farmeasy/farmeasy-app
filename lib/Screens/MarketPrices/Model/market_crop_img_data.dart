class MarketCropImgResponseModel {
  int? total;
  int? totalHits;
  List<Hits>? hits;

  MarketCropImgResponseModel({this.total, this.totalHits, this.hits});

  MarketCropImgResponseModel.fromJson(Map<String, dynamic> json) {
    total = json['total'];
