...
class ChatScreen extends StatefulWidget {
  ChatScreen(
      ...
      required this.isEnquiryCreatedByMe,
      required this.isEnquiryDisplay});
  final int landId;
  final int enquiryId;
  final int userId;
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        width: Get.width * 0.7,
                        child: Text(
                          widget.isEnquiryDisplay == false
                              ? ""
                              : "Enquiry created by ${widget.isEnquiryCreatedByMe == true ? "you" : "${widget.userName}"} at ${widget.enquiryData}",
                          overflow: TextOverflow.ellipsis,
                          style: TextStyle(
                            color: Color(0xFF333333),
                            fontSize: 10,
                ...
                Container(
                  ...
                  child: Obx(() => ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          final isSeen = chatController
                              .chatData.value.result?.data?[index].isSeen;
                          final displayIndex = chatController
                                  .chatData.value.result!.data!.length -
                              1 -
                              index;
                          final message = chatController
                              .chatData.value.result!.data![displayIndex];
