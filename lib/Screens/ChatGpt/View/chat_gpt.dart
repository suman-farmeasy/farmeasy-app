              ...
              child:Obx(() {
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    final reversedIndex = chatgpt.messages.length - index - 1;
                    ...
                    return Align(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: message.isMe ? AppColor.CHATGPTSENDCOLOR : Colors.white.withOpacity(0.20000000298023224),
                          borderRadius: BorderRadius.circular(10),
                        ),
                        child: Text(
                          message.text,
                          style: message.isMe ?  GoogleFonts.raleway(
                            color: Colors.white,
                            fontSize: 15.38,
