...
RxList allEnquiriesList = [].obs;
  ...
  void setRxRequestData(AllEnquiriesResponseModel _value)=>allenquiriesData.value=_value;
  Future<void> allEnquiries() async {
    ...
    {"Authorization":'Bearer ${ await _prefs.getUserAccessToken()}',
      ...
      if (allenquiriesData.value.result?.data != null) {
        totalPages.value = allenquiriesData.value.result!.pageInfo!.totalPage!.toInt();
