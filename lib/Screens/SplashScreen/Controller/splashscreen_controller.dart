...
class SplashController extends GetxController with SingleGetTickerProviderMixin {
  ...
  void onInit() {
    ...
    print("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@     location controller initilized");
    ...
    animationTop = Tween<Offset>(begin: Offset(0, -5), end: Offset(0, -1.2)).animate(controllerTop);
    animationBottom = Tween<Offset>(begin: Offset(0, 5), end: Offset(0, 1)).animate(controllerBottom);
