class WeatherForecastResponseModel {
  ...
  WeatherForecastResponseModel(
      {this.city, this.cod, this.message, this.cnt, this.listWeather});
  ...
  WeatherForecastResponseModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['list'] != null) {
      ...
      json['list'].forEach((v) {
        listWeather!.add(new ListWeather.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['cnt'] = this.cnt;
    if (this.listWeather != null) {
      data['list'] = this.listWeather!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
