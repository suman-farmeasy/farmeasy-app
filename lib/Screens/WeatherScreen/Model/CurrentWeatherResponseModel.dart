...
/// base : "stations"
/// main : {"temp":281.7,"feels_like":281.7,"temp_min":280.8,"temp_max":283.94,"pressure":1015,"humidity":78,"sea_level":1015,"grnd_level":928}
/// visibility : 10000
/// wind : {"speed":1.3,"deg":84,"gust":2.36}
/// clouds : {"all":38}
/// dt : 1709900730
/// sys : {"type":2,"id":2004688,"country":"IT","sunrise":1709876445,"sunset":1709917980}
/// timezone : 3600
/// id : 3163858
/// name : "Zocca"
/// cod : 200
...
class CurrentWeatherResponseModel {
  ...
  CurrentWeatherResponseModel.fromJson(dynamic json) {
  ...
  String? _name;
  num? _cod;
CurrentWeatherResponseModel copyWith({  Coord? coord,
  List<Weather>? weather,
  String? base,
  Main? main,
  num? visibility,
  ...
  String? name,
  num? cod,
}) => CurrentWeatherResponseModel(  coord: coord ?? _coord,
