    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        child: SingleChildScrollView(child: Obx(() {
          return currentWeather.loading.value
              ? Center(
                            ...
                            Container(
                              ...
                              child: Obx(() {
                                return ListView.builder(
                                  ...
                                  itemCount: forecastController.weatherForecast
                                          .value.listWeather?.length ??
                                      0,
                                  scrollDirection: Axis.vertical,
                                  itemBuilder: (context, index) {
                                    final dayAndDateList = forecastController
                                        .convertUnixTimestampToDayAndDate();
                                    final day = dayAndDateList.isNotEmpty
                                        ? dayAndDateList[index]['day'] ?? ''
                                        : '';
                                    final date = dayAndDateList.isNotEmpty
                                        ? dayAndDateList[index]['date'] ?? ''
                                        : '';
                                    final tempDay = forecastController
                                            .weatherForecast
                                            .value
                                            .listWeather?[index]
                                            .temp
                                            ?.day ??
                                        0;
                                    final tempNight = forecastController
                                            .weatherForecast
                                            .value
                                            .listWeather?[index]
                                            .temp
                                            ?.night ??
                                        0;
                                    final weatherIcon = forecastController
                                            .weatherForecast
                                            .value
                                            .listWeather?[index]
                                            .weather?[0]
