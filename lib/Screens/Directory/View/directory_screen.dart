        ...
        child: Scaffold(
            ...
            body: LayoutBuilder(builder: (context, constraints) {
              return RefreshIndicator(
                onRefresh: () async {
                  await landownerController.refreshAlllandownerdata();
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: TextFormField(
                                          controller: landownerController
                                              .searchController,
                                          onChanged: (query) {
                                            landownerController
                                                .searchLandOwner(query);
                                          },
                                                        ...
                                                        child: Container(
                                                            ...
                                                            decoration: BoxDecoration(
                                                                image: DecorationImage(
                                                                    image: NetworkImage(
                                                                        "${landownerController.landOwnerData[index].image ?? ""}"),
                                                                    fit: BoxFit
                                                                        .cover),
                                                                color: AppColor
                                                                    .DARK_GREEN,
                                                                  ...
                                                                  Get.to(() =>
                                                                      ChatScreen(
                                                                        landId:
                                                                            0,
                                                                        enquiryId:
                                                                            landownerController.landOwnerData[index].enquiryId ??
                                                                                0,
                                                                        userId:
                                                                            landownerController.landOwnerData[index].userId?.toInt() ??
                                                                                0,
                                                                        userType:
                                                                            landownerController.landOwnerData[index].userType ??
                                                                                "",
                                                                        userFrom:
                                                                            landownerController.landOwnerData[index].livesIn ??
                                                                                "",
                                                                        userName:
                                                                            landownerController.landOwnerData[index].fullName ??
                                                                                "",
                                                                        image: landownerController.landOwnerData[index].image ??
                                                                            "",
                                      ...
                                      Obx(() {
                                        return landownerController.loading.value
                                            ? Center(
                                                child:
                                                          ...
                                                          InkWell(
                                                            ...
                                                            child: Container(
                                                                ...
                                                                decoration: BoxDecoration(
                                                                    image: DecorationImage(
                                                                        image: NetworkImage(
                                                                            "${farmerController.farmerData[index].image ?? ""}"),
                                                                        fit: BoxFit
                                                                            .cover),
                                                                    color: AppColor
                                                                        .DARK_GREEN,
                                                                  ...
                                                                  child: ListView
                                                                      .builder(
                                                                          scrollDirection: Axis
                                                                              .horizontal,
                                                                          itemCount: farmerController.farmerData[index].expertise!.length ??
                                                                              0,
                                                                          itemBuilder:
                                                                              (context, indexes) {
                                                                            return Container(
                                                                      ...
                                                                      Get.to(() =>
                                                                          ChatScreen(
                                                                            landId:
                                                                                0,
                                                                            enquiryId:
                                                                                farmerController.farmerData[index].enquiryId?.toInt() ?? 0,
                                                                            userId:
                                                                                farmerController.farmerData[index].userId?.toInt() ?? 0,
                                                                            userType:
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: TextFormField(
                                          controller:
                                              landController.searchController,
                                          onChanged: (query) {
                                            landController
                                                .searchLandsData(query);
                                          },
                                          decoration: InputDecoration(
                                              contentPadding:
                                                  EdgeInsets.symmetric(
                                                                          ...
                                                                          child: ListView.builder(
                                                                              ...
                                                                              itemBuilder: (context, imgindex) {
                                                                                return Container(
                                                                                  ...
                                                                                  decoration: BoxDecoration(borderRadius: BorderRadius.circular(10), image: DecorationImage(image: NetworkImage("${landController.landData[index].landImages?[imgindex].image}"), fit: BoxFit.cover)),
                                                                                );
                                                                              }),
                                                                        ),
                                                                        Row(
                                                                        ...
                                                                        SizedBox(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            scrollDirection:
                                                                                Axis.vertical,
                                                                            itemCount:
                                                                                landController.landData[index].cropToGrow?.length ?? 0,
                                                                            itemBuilder:
                                                                                (context, cropdata) {
                                                                              return Text(
