                    ...
                    if (homecontroller.loading.value &&
                      ...
                      return ListView.builder(
                          ...
                          itemBuilder: (context, landIndex) {
                            int landId = homecontroller.alllandListData[landIndex].id!.toInt();
                            final matchingfarmerController = Get.put(HomeScreenMatchingFarmerController(landId), tag: landId.toString());
                            return InkWell(
                              onTap: () {
                                Get.to(() => LandDetails(
                                    id:homecontroller.alllandListData[landIndex].id!.toInt())
                                );
                              },
                              child: Container(
                                  ...
                                  children: [
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Column(
                                            ...
                                            children: [
                                              Text(
                                                homecontroller.alllandListData[landIndex]
                                                    .landTitle ??
                                                    "",
                                                style:
                                                GoogleFonts.poppins(
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  Container(
                                                    ...
                                                    child: Text(
                                                      overflow: TextOverflow.ellipsis,
                                                      homecontroller.alllandListData[
                                                      landIndex]
                                                          .weatherDetails
                                                          ?.description ??
                                                          "",
                                    ...
                                    Container(
                                        ...
                                        child: Container(child: Column(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            Text("Matching farmers for this land",style: GoogleFonts.poppins(fontSize: 12,fontWeight: FontWeight.w500,color: AppColor.BROWN_TEXT),),
                                            Obx(()=>  matchingfarmerController.matchingFarmerData.value.result
                                                ?.matchingFarmerList?.length != 0
                                                ? Container(
                                                                ...
                                                                InkWell(
                                                                  onTap: () {
                                                                    Get.to(
                                                                          ...
                                                                          enquiryId: matchingfarmerController
                                                                              .matchingFarmerData
                                                                              .value
                                                                              .result!
                                                                              ...
                                                                              ?.toInt() ??
                                                                              0,
                                                                          userId: matchingfarmerController
                                                                              .matchingFarmerData
                                                                              .value
                                                                              .result!
                                                                              .matchingFarmerList?[index]
                                                                          ...
                                                                          userType: matchingfarmerController
                                                                              ...
                                                                              .userType ??
                                                                              "",
                                                                          userFrom: matchingfarmerController
                                                                              .matchingFarmerData
                                                                              .value
                                                                              .result!
                                                                              .matchingFarmerList?[index]
                                                                              .livesIn ??
                                                                              "",
                                                                          userName: matchingfarmerController
                                                                              .matchingFarmerData
                                                                              .value
                                                                              .result!
                                                                              .matchingFarmerList?[index]
