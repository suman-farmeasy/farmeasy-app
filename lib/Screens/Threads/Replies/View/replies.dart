        ...
        appBar: PreferredSize(
          ...
          child: AppBar(
            ...
            flexibleSpace: Padding(
              padding: const EdgeInsets.only(top: 50, left: 10, right: 30,bottom: 0),
              child: Row(
                children: [
                  IconButton(
                      onPressed: () {
              ...
              Container(
                ...
                child: Obx((){
                  return ListView.builder(
                      shrinkWrap: true,
                      itemCount: controller.repliesData.value.result?.data?.length??0,
                      controller:controller.scrollController,
                      scrollDirection: Axis.vertical,
                      reverse: true,
                      itemBuilder: (context, index) {
                        final displayIndex = controller.repliesData.value.result!.data!.length - index - 1;
                        final replies= controller.repliesData.value.result!.data![displayIndex];
                        return ListTile(
                          leading: Container(
                            width: 40,
                            height: 40,
              ...
              Align(
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                   Obx(() {
                     return    controller.getProfileController.getProfileData.value.result?.image==""?
                     SvgPicture.asset("assets/img/Vector.svg",width: Get.width*0.11,):
                     CircleAvatar(
                       radius: 23,
                            ...
                            Container(
                              ...
                              child: Padding(
                                ...
                                child: TextField(
                                  ...
                                  controller: replyController.replyController.value,
