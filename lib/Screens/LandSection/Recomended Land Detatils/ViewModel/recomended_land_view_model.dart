...
class RecomendedLandDetailsViewModel{
  ...
  Future<RecommendedLandDetailsResponseModel>landDetails(var headerMap, int id)async{
    dynamic response = await _api.getApi(ApiUrls.RECOMENDED_LAND_DETAILS+'$id', true, headerMap);
