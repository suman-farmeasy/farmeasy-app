          ...
          return controller.loading.value?Center(child: CircularProgressIndicator()):
            ...
            children: [
              Obx(() {
                return  InkWell(
                  onTap: () {
                    double? longitude = double.tryParse(controller.landDetails.value.result!.longitude ?? '');
                    double? latitude = double.tryParse(controller.landDetails.value.result!.latitude ?? '');

                    if (longitude != null && latitude != null) {
                      Get.to(() => WeatherScreen(lat: latitude, long: longitude));
                    } else {
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Text('${currentWeather.currentWeatherData.value.name??""}',style: GoogleFonts.poppins(
                              ...
                              Container(
                                ...
                                child: ListView.builder(
                                    itemCount: currentWeather.currentWeatherData.value.weather?.length ?? 0,
                                    shrinkWrap: true,
                            ...
                            children: [
                              Container(
                                ...
                                child: ListView.builder(
                                    ...
                                    physics: NeverScrollableScrollPhysics(),
                                    itemBuilder: (context, weatherIndex) {
                                      String iconUrl = "http://openweathermap.org/img/wn/${currentWeather
                              ...
                              Text(
                                'Min: ${currentWeather.currentWeatherData
                                    .value.main?.tempMin?.toInt()??0}º / Max: ${currentWeather
                                    .currentWeatherData.value.main
                                    ?.tempMax?.toInt() ?? 0}º',
              ...
              Obx(() {
                return  controller.landDetails.value.result?.landImages?.length !=0? Container(
                  margin: EdgeInsets.symmetric(vertical: 20),
                  height: Get.height*0.25,
                  child: ListView.builder(
                      itemCount: controller.landDetails.value.result?.landImages?.length??0,
                                  ...
                                  children: List.generate(
                                    450 ~/ 10,
                                      ...
                                      child: Container(
                                        ...
                                        width: 1, // Height changed to width
                                      ),
                                    ),
                                  ),
                                ),
                                    ...
                                    children: [
                                      ...
                                      SizedBox(
                                        ...
                                        child: ListView.builder(
                                          ...
                                          itemCount: controller.landDetails.value.result?.cropToGrow?.length??0 ,
                                          itemBuilder: (context, cropdata){
                                            return Text(
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            SvgPicture.asset( ImageConstants.ENQUIRIES,width: Get.width*0.06,),
                            Text(
                              'Contact Land Owner',
                              style: GoogleFonts.poppins(
                                color:AppColor.DARK_GREEN,
                    ...
                    children: [
                      ...
                      ListTile(
                        ...
                        subtitle: Container(
                          ...
                          child: ListView.builder(
                            scrollDirection: Axis.horizontal,
                            itemCount: controller.landDetails
                                .value.result?.cropToGrow?.length??0,
                          ...
                          child: Column(
                            ...
                            children: [
                                    ...
                                    Container(
                                      ...
                                      child: ListView.builder(
                                        ...
                                        itemCount: controller
                                            .landDetails.value.result?.cropsGrown?.length??0,
                                        itemBuilder: (context, index) {
                                          final crop = controller
                                              .landDetails.value.result?.cropsGrown?[index];
                                          return Text(
                                            " ${crop?.name ?? ""},",
                                            style: GoogleFonts.poppins(
                                              color: Color(0xA3044D3A),
                              ...
                              ListTile(
                                  ...
                                  subtitle: controller.landDetails.value.result?.organicCertification == false ? Text("Not Uploaded",style: GoogleFonts.poppins(
                                    color: Color(0xA3044D3A),
                                    fontSize: 10,
                                    fontWeight: FontWeight.w500,
                                    height: 0,
                                  ...
                                  InkWell(
                                    onTap: (){
                                      Get.to(()=>PdfViewer(pdfUrl: "${controller.landDetails.value.result?.certificationDocumnet??""}" ,));
                                    },
                                    child: Text(
                                      "view",
                                      style: GoogleFonts.poppins(
