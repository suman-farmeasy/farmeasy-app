...
class MatchingAgriServiceViewModel{
  ...
  Future<MatchingAgriProviderResponseModel>matchingAgriProvider( var headerMap,int id)async{
    dynamic response = await _apiServices.getApi(ApiUrls.GET_MATCHING_AGRIPROVIDER+"$id",true, headerMap);
