...
class MatchingFarmerViewModel{
  ...
  Future<MatchingFarmerResponseModel>matchingFarmerData(var headerMap,int id)async{
    dynamic response = await _api.getApi(ApiUrls.GET_MATCHING_FARMER+"$id", true, headerMap,);
