...
/// result : {"data":[{"id":49,"enquiry_type":"Land Enquiry","land":71,"connected_person_name":"sahil","connected_person_image":"","connected_person_address":"Pandri, Raipur, Chhattisgarh","connected_person_user_id":55,"connected_person_user_type":"Farmer","last_message":"hi","unseen_message_count":0,"last_message_date":"12 min ago","is_created_by_me":true,"created":"02:54 PM, 30/03/24"},{"id":50,"enquiry_type":"Land Enquiry","land":71,"connected_person_name":"shri","connected_person_image":"","connected_person_address":"Panvel, Navi Mumbai, Maharashtra, India","connected_person_user_id":74,"connected_person_user_type":"Farmer","last_message":"hi","unseen_message_count":0,"last_message_date":"12 min ago","is_created_by_me":true,"created":"02:54 PM, 30/03/24"},{"id":51,"enquiry_type":"Land Enquiry","land":71,"connected_person_name":"shrisahil","connected_person_image":"http://139.5.189.24:8000/media/user_image/image_cropper_1711696866649.jpg","connected_person_address":"Pandri, Raipur, Chhattisgarh, India","connected_person_user_id":84,"connected_person_user_type":"Farmer","last_message":"hi","unseen_message_count":0,"last_message_date":"Just now","is_created_by_me":true,"created":"03:07 PM, 30/03/24"}],"page_info":{"total_page":1,"total_object":3,"current_page":1}}

EnquiriesListResponseModel enquiriesListResponseModelFromJson(String str) => EnquiriesListResponseModel.fromJson(json.decode(str));
String enquiriesListResponseModelToJson(EnquiriesListResponseModel data) => json.encode(data.toJson());
class EnquiriesListResponseModel {
  EnquiriesListResponseModel({
      String? detail, 
      Result? result,}){
    _detail = detail;
    _result = result;
  ...
  EnquiriesListResponseModel.fromJson(dynamic json) {
    _detail = json['detail'];
    _result = json['result'] != null ? Result.fromJson(json['result']) : null;
  }
  String? _detail;
  Result? _result;
EnquiriesListResponseModel copyWith({  String? detail,
  Result? result,
}) => EnquiriesListResponseModel(  detail: detail ?? _detail,
...
/// data : [{"id":49,"enquiry_type":"Land Enquiry","land":71,"connected_person_name":"sahil","connected_person_image":"","connected_person_address":"Pandri, Raipur, Chhattisgarh","connected_person_user_id":55,"connected_person_user_type":"Farmer","last_message":"hi","unseen_message_count":0,"last_message_date":"12 min ago","is_created_by_me":true,"created":"02:54 PM, 30/03/24"},{"id":50,"enquiry_type":"Land Enquiry","land":71,"connected_person_name":"shri","connected_person_image":"","connected_person_address":"Panvel, Navi Mumbai, Maharashtra, India","connected_person_user_id":74,"connected_person_user_type":"Farmer","last_message":"hi","unseen_message_count":0,"last_message_date":"12 min ago","is_created_by_me":true,"created":"02:54 PM, 30/03/24"},{"id":51,"enquiry_type":"Land Enquiry","land":71,"connected_person_name":"shrisahil","connected_person_image":"http://139.5.189.24:8000/media/user_image/image_cropper_1711696866649.jpg","connected_person_address":"Pandri, Raipur, Chhattisgarh, India","connected_person_user_id":84,"connected_person_user_type":"Farmer","last_message":"hi","unseen_message_count":0,"last_message_date":"Just now","is_created_by_me":true,"created":"03:07 PM, 30/03/24"}]
/// page_info : {"total_page":1,"total_object":3,"current_page":1}
...
/// land : 71
/// connected_person_name : "sahil"
/// connected_person_image : ""
/// connected_person_address : "Pandri, Raipur, Chhattisgarh"
/// connected_person_user_id : 55
/// connected_person_user_type : "Farmer"
/// last_message : "hi"
/// unseen_message_count : 0
/// last_message_date : "12 min ago"
/// is_created_by_me : true
/// created : "02:54 PM, 30/03/24"
