                      ...
                      children: [
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                image: NetworkImage(controller.followerslist.value.result?.data?[index].followerImage ?? ""),
                              ),
                            ),
                          ),
                        ),
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                controller.followerslist.value.result?.data?[index].followerName ?? "",
                              ...
                              SizedBox(height: 10),
                              Text(
                                controller.followerslist.value.result?.data?[index].followerAddress ?? "",
                                overflow: TextOverflow.ellipsis,
                                maxLines: 1,
                                style: GoogleFonts.poppins(
                        ...
                        GestureDetector(
                          onTap: () {
                            print("${controller.followerslist.value.result?.data?[index].followerUserId?.toInt() ?? 0}");
                            followUnfollowController.followUnfollow(controller.followerslist.value.result?.data?[index].followerUserId?.toInt() ?? 0);
