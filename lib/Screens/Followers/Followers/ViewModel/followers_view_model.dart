...
class FollowersListViewModel{
  ...
  Future<FollowersListResponseModel>followersList(var headerMap, int userId, int currentPage)async{
    dynamic response = await _api.getApi(ApiUrls.FOLLOWERS_LIST+'$userId&page=$currentPage', true, headerMap);
