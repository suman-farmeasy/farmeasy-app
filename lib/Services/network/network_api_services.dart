...
class NetworkApiServices extends BaseApiServices{
  ...
  Future getApi(String url,bool sendHeaders,  var headerMap) async{
    ...
    try {
      final response = await http.get(Uri.parse(url),headers: sendHeaders?headerMap:{});
     // if(kDebugMode){
        print("-------------------------------Raw Response-----------------------------------");
        print(response);
        print("----------------******------------------------------*****------------------");
  ...
  Future putApi(String url,bool sendHeaders,  var headerMap) async{
    ...
    dynamic responseJson;
    try {
      final response = await http.put(Uri.parse(url),headers: sendHeaders?headerMap:{});
      // if(kDebugMode){
      print("-------------------------------Raw Response-----------------------------------");
      print(response);
      print("----------------******------------------------------*****------------------");
  ...
  Future postApi(String url,var data,bool sendHeaders,var headerMap) async{
    ...
    dynamic responseJson;
    try {
      final response = await http.post(Uri.parse(url),body: data,headers:sendHeaders? headerMap :{});
      if(kDebugMode){
        print("-------------------------------Raw Response-----------------------------------");
        print(response.body);
        print("----------------******------------------------------*****------------------");
  ...
  Future patchApi(String url,var data,bool sendHeaders,var headerMap) async{
    ...
    dynamic responseJson;
    try {
      final response = await http.patch(Uri.parse(url),body: data,headers:sendHeaders? headerMap :{});
      if(kDebugMode){
        print("-------------------------------Raw Response-----------------------------------");
        print(response.body);
        print("----------------******------------------------------*****------------------");
  ...
  Future uploadImage(
    ...
    request.files.add(await http.MultipartFile.fromPath('profile_picture', image, contentType: MediaType('image', 'jpeg')));
